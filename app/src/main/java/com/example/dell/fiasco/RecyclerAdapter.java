...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
    ...
    private int[] images = {R.drawable.ic_birthday, R.drawable.ic_birthday, R.drawable.ic_birthday, R.drawable.ic_birthday, R.drawable.ic_birthday, R.drawable.ic_birthday, R.drawable.ic_birthday, R.drawable.ic_birthday};
